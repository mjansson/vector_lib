...
main_run(void* main_arg) {
	...
	log_infof(HASH_TEST, STRING_CONST("Vector library v%s built for %s using %s (%.*s%.*s)"),
	          string_from_version_static(vector_module_version()).str, FOUNDATION_PLATFORM_DESCRIPTION,
